---
id: maning-convention
title: Naming Convention
---

## Naming Convention

Design tokens — and their names — become more crucial as systems of visual style spread over an expanding ecosystem of components, platforms, and outputs. The sequence in which names are used is fundamental since it conveys meaning and serves to standardize terminology throughout the entire organization.
